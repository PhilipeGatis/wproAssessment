...
//
//    @GET
//    public Response listAll(@QueryParam("idAssessment") String idAssessment) {
//        return Response.ok(service.list(idAssessment)).build();
//    }
//
//    @GET
//    @Path("/all")
...
//        competencePolicy.setId(new ObjectId(id));
